  ...
  return (
    <main className="relative h-screen overflow-hidden max-w-screen">
      ...
      >
        ...
        <section id="home" className="flex min-w-full snap-start items-center justify-center px-6 sm:px-6 lg:px-8 pt-32 pb-12 sm:pt-40 lg:pt-48">
          <div className="mx-auto max-w-4xl w-full">
            <div className="text-center px-0 leading-5">

              <ScrollAnimation delay={0.1}>
                <h1 className="mb-8 sm:mb-8 text-balance text-3xl sm:text-5xl md:text-6xl lg:text-8xl tracking-tight text-black font-bold">
              ...
              <ScrollAnimation delay={0.2}>
                <p className="mb-8 sm:mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-700 font-light tracking-wide text-sm sm:text-lg lg:text-xl px-2 sm:px-0">
              ...
              <ScrollAnimation delay={0.3}>
                <div className="flex justify-center gap-4 mb-10 sm:mb-0">
                  <ShinyButton className="px-6 py-3 sm:px-8 sm:py-3 text-sm sm:text-base bg-black text-white hover:bg-gray-800 min-h-[44px]">
                    Shop Now
                  </ShinyButton>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation delay={0.4} className="mt-10 sm:mt-10 lg:mt-12 max-w-4xl mx-auto px-0 sm:px-4 lg:px-0">
                <Swiper
                ...
                >
                  <SwiperSlide>
                    <div className="group relative w-full aspect-square rounded-2xl sm:rounded-3xl bg-white border-2 border-gray-200 overflow-hidden hover:scale-105 hover:border-gray-900 transition-all shadow-2xl">
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              <ScrollAnimation>
                <h1 className="text-3xl font-semibold tracking-tight lg:text-5xl text-black">
                  Shop Our Collection
                </h1>
              </ScrollAnimation>
              <ScrollAnimation delay={0.1}>
                <p className="text-gray-700 mt-5 text-sm md:text-lg leading-relaxed px-2">
        ...
        <section
          id="about"
          ref={aboutSectionRef}
          className="relative min-w-full snap-start overflow-y-auto px-6 sm:px-6 pt-28 sm:pt-32 pb-20 sm:pb-20 [&::-webkit-scrollbar]:hidden"
          style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
        >
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            ...
            <div className="mx-auto mb-10 sm:mb-12 max-w-3xl text-center">
              <ScrollAnimation>
                <h1 className="text-3xl sm:text-4xl font-bold tracking-tight lg:text-5xl text-black mb-4 sm:mb-4">
                  Our Story
                </h1>
              </ScrollAnimation>
              <ScrollAnimation delay={0.1}>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-8 lg:gap-12">
              ...
              <div className="relative order-1 lg:order-none">
                <div className="lg:sticky lg:top-8">
                  <ScrollAnimation variant="zoom" duration={0.8}>
                    <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white border-2 border-gray-200 shadow-xl sm:shadow-2xl h-[350px] sm:h-[400px] lg:h-[600px]">
                      <img
              ...
              {/* Content Section */}
              <div className="space-y-6 sm:space-y-6 order-2 lg:order-none">
                {/* Mission Card */}
                <ScrollAnimation delay={0.2} variant="slideLeft">
                  <div className="rounded-xl sm:rounded-2xl bg-white border-2 border-gray-200 p-5 sm:p-8 shadow-lg hover:border-gray-900 transition-all duration-300">
                    <h3 className="text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-4">
                      Our Mission
                    </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-4">
                  <ScrollAnimation delay={0.3} className="h-full">
                    <div className="rounded-xl sm:rounded-xl bg-white border-2 border-gray-200 p-5 sm:p-6 shadow-md hover:shadow-lg hover:border-gray-900 transition-all duration-300 h-full">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black flex items-center justify-center mb-4 sm:mb-4">
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            ...
            <div className="mx-auto mb-12 sm:mb-16 max-w-3xl text-center">
              <ScrollAnimation>
                <h1 className="text-3xl sm:text-4xl font-bold tracking-tight lg:text-5xl text-black mb-5">
                  Get in Touch
                </h1>
              </ScrollAnimation>
              <ScrollAnimation delay={0.1}>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <ScrollAnimation delay={0.2} variant="slideRight">
                    <div className="group rounded-xl sm:rounded-2xl bg-white border-2 border-gray-200 p-5 shadow-lg hover:shadow-xl hover:border-gray-900 transition-all duration-300">
              ...
              <ScrollAnimation delay={0.3} variant="slideLeft" className="h-full">
                <div className="rounded-xl sm:rounded-2xl bg-white border-2 border-gray-200 p-6 sm:p-8 shadow-xl ">
                  <h2 className="text-2xl font-bold text-black mb-3">Send us a Message</h2>
                  ...
                  <form className="space-y-5">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-gray-50 border-2 border-gray-200 text-black placeholder:text-gray-400 focus:border-black focus:ring-0 transition-colors h-12 text-base"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        rows={5}
                        className="bg-gray-50 border-2 border-gray-200 text-black placeholder:text-gray-400 focus:border-black focus:ring-0 transition-colors resize-none text-base"
                      />
                    </div>

                    <Button
                      type="button"
                      className="w-full bg-black text-white hover:bg-gray-800 font-semibold py-6 text-base shadow-lg hover:shadow-xl transition-all duration-300 min-h-[48px]"
                    >
                      Send Message
                    </Button>
                  </form>
